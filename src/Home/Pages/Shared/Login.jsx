                ...
                fetch("https://assignmetn-12-server-side.vercel.app/users", {
                    ...
                    .then(() => {
                        Swal.fire({
                            position: "top-end",
                            icon: "success",
                            title: "Signin Successfully with Google",
                            showConfirmButton: false,
                            timer: 1500
                        })
                        .then(() => {
        ...
        <div className='grid md:grid-cols-2 max-w-10/12 mx-auto md:mt-40 md:mb-96 lg:mt-10 lg:mb-40'>
            ...
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl lg:ml-40">
                ...
                <div className="card-body">
                    ...
                    <Link to='/register'><p className='text-[17px]'>You have no account? Please <span className='text-blue-500 font-bold underline'>Register</span></p></Link>
